        ...
        <div className="bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row w-full max-w-4xl">
          ...
          <div className="flex-1 p-5">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="w-full max-w-xs flex items-start mb-1">
                <lebel>Username/Email: <span className="text-red-500">*</span></lebel>
              </div>

              <div className="bg-gray-100 w-full max-w-xs p-2 flex items-center mb-3 border-2 border-gray-300">
              ...
              <div className="w-full max-w-xs flex items-start mb-1">
                <lebel>Password: <span className="text-red-500">*</span></lebel>
              </div>

              <div className="bg-gray-100 w-full max-w-xs p-2 flex items-center mb-4 border-2 border-gray-300">
              ...
              <div className="bg-gray-100 w-full max-w-xs flex flex-row items-center mb-3 border-2 border-gray-300 relative">
              ...
              <div className="bg-gray-100 w-full max-w-xs p-2 flex items-center mb-4 border-2 border-gray-300">
                <input type="text" name="captcha_code" id="captcha_code" autoComplete="off" placeholder="Captcha" className="bg-gray-100 outline-none text-sm flex-1" />
              </div>

              <div className="flex justify-between w-full max-w-xs mb-5">
                <label className="flex items-center text-xs hover:text-green-600">
